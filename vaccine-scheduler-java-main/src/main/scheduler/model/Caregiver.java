...
public class Caregiver {
    ...
    public static void getCaregiverUsernames(Date d) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();
        String getCaregivers = "SELECT Username FROM Availabilities WHERE Time = ? ORDER BY desc(Username)";
        try {
